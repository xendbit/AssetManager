...
contract AssetManager is IAssetManager {
    ...
    function _matchOrder(OrderModel.Order memory mo) internal {
        OrderModel.Order memory matchingOrder = mo;
        bool matched = false;
    ...
    function _processOrder(
        OrderModel.Order memory buyOrder,
        OrderModel.Order memory sellOrder) internal returns (Constants.Values memory returnValues) {
    ...
    function _transferAndPay(
        ...
        address assetIssuer,
        uint256 amount, uint256 p) internal {
